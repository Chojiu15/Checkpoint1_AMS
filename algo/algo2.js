/*
Write a function which can determine whether a year
is a leap year. It must return `true` if it is, and `false`
otherwise.
...
Note bene: To check whether a number is
divisible by another, you should use the "modulo" operator (%)
*/
